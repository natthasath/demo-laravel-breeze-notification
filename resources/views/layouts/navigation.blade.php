    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('notify-icon')" :active="request()->routeIs('notify-icon')">
                        {{ __('Notify Icon') }}
                    </x-nav-link>
                </div>
            </div>
  ...
  <div class="divide-y divide-gray-100 dark:divide-gray-700">
    <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
      <div class="flex-shrink-0">
        <img class="rounded-full w-11 h-11" src="{{ asset('notification-icon.png') }}" alt="Jese image">
    ...
    <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
      <div class="flex-shrink-0">
        <img class="rounded-full w-11 h-11" src="{{ asset('notification-icon.png') }}" alt="Joseph image">
    ...
    <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
      <div class="flex-shrink-0">
        <img class="rounded-full w-11 h-11" src="{{ asset('notification-icon.png') }}" alt="Bonnie image">
    ...
    <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
      <div class="flex-shrink-0">
        <img class="rounded-full w-11 h-11" src="{{ asset('notification-icon.png') }}" alt="Leslie image">
    ...
    <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
      <div class="flex-shrink-0">
        <img class="rounded-full w-11 h-11" src="{{ asset('notification-icon.png') }}" alt="Robert image">
...
<span class="sr-only">Notifications</span>
  <div class="absolute inline-flex items-center justify-center w-6 h-6 text-xs font-bold text-white bg-red-500 border-2 border-white rounded-full -top-2 -end-2 dark:border-gray-900">20</div>
                ...
                {{--<div class="relative inline-block text-left">
                    <!-- Bell Icon -->
                    <button type="button" class="text-gray-400 hover:text-gray-500 focus:outline-none" id="notificationButton" aria-expanded="false" aria-haspopup="true">
                    ...
                    <!-- Dropdown Menu -->
                    <div class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="notificationButton" tabindex="-1" style="display: none;">
                        <div class="py-1" role="none">
                            <!-- Notification items go here -->
                            <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900" role="menuitem">Notification 1</a>
                            <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900" role="menuitem">Notification 2</a>
                        </div>
                    </div>
                </div>--}}
...
<script>
    ...
    notificationButton.addEventListener('click', () => {
        const expanded = notificationButton.getAttribute('aria-expanded') === 'true' || false;
